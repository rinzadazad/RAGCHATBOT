            ...
            <div className="max-w-4xl mx-auto w-full p-4 space-y-6">
                ...
                <div key={msg.id}>
                  ...
                  {msg.from_web && (
                    <div className="flex items-center gap-1.5 mt-1 ml-11 text-xs text-muted-foreground">
                      ...
                      <span className="text-blue-400">Answer based on external web sources</span>
                    </div>
                  )}
                </div>
              ))}
              ...
              {pendingWebSearch && !isStreaming && (
                <div className="flex gap-3 animate-fade-in">
                  ...
                  <div className="bg-blue-500/5 border border-blue-500/20 rounded-2xl rounded-tl-sm px-4 py-3 max-w-[80%]">
                    <p className="text-sm font-medium mb-3">Search the internet for more information?</p>
                      ...
                      return (
                        ...
                        >
                          ...
                          {doc.source_type === 'url'
                            ...
                            ? <Type className="w-3.5 h-3.5 text-purple-500 flex-shrink-0" />
